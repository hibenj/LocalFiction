...
#include <fiction/algorithms/network_transformation/fo_inv_balancing.hpp>
...
TEST_CASE("Name conservation blc", "[network-blc]")
{
    ...
    const auto balanced_fib = inv_balancing<mockturtle::fanout_view<mockturtle::names_view<technology_network>>>(substituted);

                ...
                if (!ctn.color_ntk.is_constant(n))
                {
                    ...
                    else  // if node has two fanins (or three fanins with one of them being constant)
                    {
                        ...
                        else if (clr == ctn.color_south)
                        {
                            ...
                            bool new_south = pre1_t.y < pre2_t.y && !ctn.color_ntk.is_fanout(pre_fo) && maj_buf[0] == 0 && maj_buf[1] == 0;
                        ...
                        else
                        {
                            ...
                            auto color11 = ctn.color_ntk.color(fos_pre1[0]);
                            auto color12 = ctn.color_ntk.color(fos_pre1[1]);
                            auto color_pre1 =
                            ...
                            auto color21 = ctn.color_ntk.color(fos_pre2[0]);
                            auto color22 = ctn.color_ntk.color(fos_pre2[1]);
                            auto color_pre2 =
                    ...
                    if (ctn.color_ntk.is_po(n))
                    {
                        ...
                        if (is_eastern_po_orientation_available(ctn, n))
                        {
                            ...
                            if (num_ris>1){
                                ...
                                layout.resize({latest_pos.x + register_offset + (num_ris-1)*5 + g_syc_const*2, latest_pos.y-1, 1});
                            }else{
                ...
                ctn.color_ntk.foreach_ri(
                    [&](const auto& n)
                    {
                        ...
                        if (ctn.color_ntk.is_ri(n))
                        {
                            ...
                            layout.resize({ri_tile.x, ri_tile.y+1 +south_ri, 1});
                            pre_clock = layout.get_clock_number({ri_tile});
